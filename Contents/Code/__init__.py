...
def Update(metadata, media, lang, force, movie):
  ...
  dict_AniDB, ANNid, MALids, TMDbid, IMDbid                     =       AniDB.GetMetadata(media, movie, error_log,       source, AniDBid, TVDBid, TMDbid, IMDbid, AnimeLists.AniDBMovieSets, mappingList)
  ...
  dict_Shikimori                                                =   Shikimori.GetMetadata(AniDBid, MainMALid)
